...
public abstract class JsonHandler<I,O> implements HttpHandler {
    ...
    protected O get(I input, List<NameValuePair> queryParams)throws IOException{throw new UnsupportedOperationException();}
    protected O post(I input, List<NameValuePair> queryParams)throws IOException{throw new UnsupportedOperationException();}
    protected O delete(I input, List<NameValuePair> queryParams)throws IOException{throw new UnsupportedOperationException();}
}
